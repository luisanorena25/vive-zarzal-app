...
// Define the name of the cities table
export const CITY_TABLE = 'ciudad';

// Define the City model
export const City = sequelize.define(CITY_TABLE, {
  ...
  // Define the foreign key to department
  departmentId: {
    // Integer type
    type: DataTypes.INTEGER,
    // This field cannot be null
